...
def plot_directivity():
        ...
        ax1.plot(elevation_angles, DI, 'b-o', linewidth=2, markersize=6)
        ...
        ax2.plot(angles_rad, DI, 'b-o', linewidth=2, markersize=6)
